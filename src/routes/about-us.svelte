...
>
	...
	>
		<Content
			...
			contentText={heritageSection.text}
		/>
	</div>
...
>
	...
	>
		{@html leadersSection.head}
	</h2>
	<ul class="list-none grid gap-x-7  gap-y-10 sm:grid-cols-2 lg:gap-y-16">
		{#each leadersSection.leaders as { name, image, position }}
			<li>
				<Leader
					leaderName={name}
					leaderImage={image}
